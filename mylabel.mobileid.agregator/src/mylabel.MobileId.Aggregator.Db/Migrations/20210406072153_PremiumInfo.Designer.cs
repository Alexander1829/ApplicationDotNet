...
namespace mylabel.MobileId.Aggregator.Db.Migrations
{
    ...
    [Migration("20210406072153_PremiumInfo")]
    partial class PremiumInfo
    {
            ...
            modelBuilder.Entity("mylabel.MobileId.Aggregator.Db.DIAuthorizationRequest", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("CodeSetAt")
                    ...
                    b.Property<DateTimeOffset?>("DcidSetAt")
                        .HasColumnType("datetimeoffset");
                    ...
                    b.Property<DateTimeOffset?>("TokenHashSetAt")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("mylabel.MobileId.Aggregator.Db.PremiumInfoToken", b =>
                {
                    ...
                    b.Property<string>("AccessTokenHashOnAggregator")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
